...
function Table() {
  const { data, isLoading } = React.useContext(Context); // Captando as keys necessárias, diretamente do contexto global.
  const thContent = ['Name', 'Rotation Period', 'Orbital Period',
    'Diameter', 'Climate', 'Gravity',
    'Terrain', 'Surface Water', 'Population',
    'Films', 'Created', 'Edited', 'URL'];

  if (isLoading) return <span>Carregando Informações...</span>;
